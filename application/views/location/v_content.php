          <?php $this->view('location/v_add'); ?>
          <?php $this->view('location/v_edit'); ?>
          <?php $this->view('location/v_delete'); ?>
          <!-- START CONTAINER FLUID -->
          <div class=" container-fluid   container-fixed-lg bg-white">
            <h3 style="padding-top: 1rem"><strong>Tabel Location</strong></h3>
            <!-- START card -->
            <div class="card card-transparent">
              <div class="card-header ">
                <!-- <div class="card-title">Tabel Location
                </div> -->
