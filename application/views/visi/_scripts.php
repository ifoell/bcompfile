...
(function($) {
    ...
    $('#btn_save').on('click', function(){
        ...
        $.ajax({
            type        : "POST",
            url         : "<?php echo site_url('visi/add')?>",
            dataType    : "JSON",
    ...
    $('#btn_save_edit').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('visi/update')?>",
                dataType : "JSON",
    ...
    $('#show_data').on('click','.item_delete',function(){
        ...
        //delete record to database
         $('#btn_delete').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('visi/delete')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $('[name="id_delete"]').val("");
                    $('#visi-delete').modal('hide');
                    show_list();
                }
            });
            return false;
