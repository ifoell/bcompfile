          <?php $this->view('visi/v_add'); ?>
          <?php $this->view('visi/v_edit'); ?>
          <?php $this->view('visi/v_delete'); ?>
          <!-- START CONTAINER FLUID -->
          <div class=" container-fluid   container-fixed-lg bg-white">
            <h3 style="padding-top: 1rem"><strong>Tabel Visi</strong></h3>
            <!-- START card -->
            <div class="card card-transparent">
              <div class="card-header ">
                <!-- <div class="card-title">Tabel Visi
                </div> -->
